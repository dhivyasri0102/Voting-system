...
| **Brute-Force Attack** | Automated SMS OTP guessing | Identity compromise | Account lockout after 3 failed attempts, strict IP and correlation rate limits | Compromise of resident's SMS carrier SIM |
